...
program
  ...
  .option('--spec-workflow [feature]', 'run Spec Kit automation for a feature (defaults to Feature-A)')
  ...
  .option('--workflow-brief <brief>', 'brief to seed Spec Kit workflow automation')
  .option('--workflow-resume <phase>', 'resume Spec Kit workflow from a specific phase')
  .option('--workflow-task <task>', 'resume Spec Kit implementation from a task label match')
  .option('--workflow-phases <phases>', 'comma-separated phases to run (specify,plan,tasks,implement)')
  .option('--workflow-dry-run', 'preview Spec Kit workflow execution without invoking agents')
