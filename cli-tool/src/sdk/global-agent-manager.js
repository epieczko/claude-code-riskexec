...
async function findAgentUrl(agentName) {
  try {
    ...
    const rootUrl = `https://raw.githubusercontent.com/riskexec/claude-code/main/cli-tool/components/agents/${agentName}.md`;
    ...
    const categoriesResponse = await fetch('https://api.github.com/repos/riskexec/claude-code/contents/cli-tool/components/agents');
    ...
    for (const item of contents) {
      if (item.type === 'dir') {
        const categoryUrl = `https://raw.githubusercontent.com/riskexec/claude-code/main/cli-tool/components/agents/${item.name}/${agentName}.md`;
        try {
