...
const config: Config = {
  ...
  projectName: 'claude-code-riskexec', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/davila7/claude-code-riskexec/tree/main/docu/',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/davila7/claude-code-riskexec',
          label: 'GitHub',
          position: 'right',
        },
      ],
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: 'https://github.com/davila7/claude-code-riskexec/issues',
            },
          ],
        },
        {
          ...
          items: [
            {
              label: 'Contribute',
              href: 'https://github.com/davila7/claude-code-riskexec/blob/main/CONTRIBUTING.md',
            },
            {
              label: 'License',
              href: 'https://github.com/davila7/claude-code-riskexec/blob/main/LICENSE',
            },
          ],
        },
      ],
