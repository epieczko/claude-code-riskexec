        ...
        <div class="modal-overlay" onclick="closeComponentModal()">
            <div class="modal-content component-modal" onclick="event.stopPropagation()">
                ...
                <div class="modal-actions">
                    <a href="https://github.com/riskexec/claude-code/tree/main/cli-tool/templates/${subtype === 'framework' ? `${template.language}/examples/${templateName}` : templateName}" target="_blank" class="github-folder-link">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
    ...
    └── settings.json  # Claude settings
                        ...
                        <div class="contribute-footer">
                            <div class="help-section">
                                <h4>Need Help?</h4>
                                <p>Check <a href="https://github.com/riskexec/claude-code/tree/main/cli-tool/templates" target="_blank">existing templates</a> for examples or open an issue on GitHub for guidance.</p>
                            </div>
                        </div>
                    </div>
                </div>
