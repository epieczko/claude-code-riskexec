        ...
        <div class="modal-overlay" onclick="closeComponentModal()">
            <div class="modal-content component-modal" onclick="event.stopPropagation()">
                ...
                <div class="modal-actions">
                    <a href="https://github.com/davila7/claude-code-riskexec/tree/main/cli-tool/templates/${subtype === 'framework' ? `${template.language}/examples/${templateName}` : templateName}" target="_blank" class="github-folder-link">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
    ...
    └── settings.json  # Claude settings
                        ...
                        <div class="contribute-step">
                            ...
                            <div class="step-content-contrib">
                                ...
                                <div class="step-command">
                                    <code>npx claude-code-riskexec@latest --template=your-template-name --yes</code>
                                    <button class="copy-btn" onclick="copyToClipboard('npx claude-code-riskexec@latest --template=your-template-name --yes')">Copy</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="contribute-footer">
                            <div class="help-section">
                                <h4>Need Help?</h4>
                                <p>Check <a href="https://github.com/davila7/claude-code-riskexec/tree/main/cli-tool/templates" target="_blank">existing templates</a> for examples or open an issue on GitHub for guidance.</p>
                            </div>
                        </div>
                    </div>
                </div>
